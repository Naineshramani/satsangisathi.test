...
use App\Http\Controllers\SatsangDetailController;
...
// Unverified users land on profile page where "Verify Now" card is shown
Route::get('/email/verify', fn() => redirect()->route('profile_settings'))->name('verification.notice')->middleware('auth');
...
// Profile, password, account management — auth only, no package/approval checks
...
Route::group(['middleware' => ['member', 'verified', 'check.package']], function () {
    ...
    Route::middleware('activated')->group(function () {
        ...
        // Gallery Image
        Route::get('/gallery_image/index', [GalleryImageController::class, 'index'])->name('gallery-image_index');
        Route::get('/gallery_image/create', [GalleryImageController::class, 'create'])->name('gallery-image_create');
...
Route::group(['middleware' => ['auth','activated']], function () {
    ...
    Route::controller(MemberController::class)->group(function () {
        ...
        Route::post('/members/documents_update', 'documents_update')->name('member.documents_update');
    });

    // Member education
    Route::controller(EducationController::class)->group(function () {
        Route::post('/education/create', 'create')->name('education.create');
        Route::post('/education/store', 'store')->name('education_store');
        Route::post('/education/edit', 'edit')->name('education.edit');
        Route::post('/education/update/{id}', 'update')->name('education_update');
        ...
        Route::get('/education/destroy/{id}', 'destroy')->name('education_destroy');
    });
    ...
    Route::patch('/satsang-details/{id}', [SatsangDetailController::class, 'update'])->name('satsang_details.update');
