...
use App\Http\Controllers\SatsangOptionController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Satsang Options
    Route::resource('/satsang-options', SatsangOptionController::class)->except(['destroy', 'create', 'show']);
    Route::get('/satsang-options/destroy/{id}', [SatsangOptionController::class, 'destroy'])->name('satsang-options.destroy');
    ...
    Route::get('/member/doc/download', [MemberController::class, 'downloadDoc'])->name('admin.member.doc.download');
