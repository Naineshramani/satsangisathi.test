...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <!-- Uploaded Documents -->
            @if ($member->biodata_file || $member->id_proof_file)
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0 h6">{{ translate('Uploaded Documents') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <h6 class="font-weight-bold mb-2">{{ translate('Biodata') }}</h6>
                            ...
                            @else
                                <p class="text-muted mb-0">{{ translate('Not uploaded') }}</p>
                            @endif
                        </div>
                        <div class="col-md-6 mb-3">
                            <h6 class="font-weight-bold mb-2">{{ translate('ID Proof') }}</h6>
