...
<table class="table">
    ...
    <tr>
        ...
        <td class="text-right">
            ...
            <a href="javascript:void(0);" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('education_destroy', $education->id)}}" title="{{ translate('Delete') }}">
