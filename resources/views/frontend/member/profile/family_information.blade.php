        ...
        <form action="{{ route('families.update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="father_occupation" value="{{ $member->families->father_occupation ?? "" }}" placeholder="{{ translate('Father Occupation') }}" class="form-control">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="text" name="mother_occupation" value="{{ $member->families->mother_occupation ?? "" }}" placeholder="{{ translate('Mother Occupation') }}" class="form-control">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <select class="form-control aiz-selectpicker" name="no_of_sisters" id="no_of_sisters" onchange="totalSibling()" data-live-search="true" data-selected="{{ $member->families->no_of_sisters ?? ""  }}">
                        @for($i=0; $i<=20; $i++)
                            <option value="{{ $i }}">{{ $i }}</option>
                        @endfor
                    </select>
