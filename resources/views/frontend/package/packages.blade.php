                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                @elseif($package->id == 1 && $user->has_purchased_free_package == 0)
                                    @if(Auth::check())
                                        <a href="{{ route('free_package_purchase', encrypt($package->id)) }}" type="submit" class="btn btn-primary" >{{translate('Activate This Free Package')}}</a>
                                    @else
                                        <button type="submit" onclick="loginModal()" class="btn btn-primary" >{{translate('Activate This Free Package')}}</button>
                                    @endif
                                @else
