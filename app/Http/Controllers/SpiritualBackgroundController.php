...
class SpiritualBackgroundController extends Controller
{
     ...
     */
     ...
     {
         $this->rules = [
             'member_religion_id'   => [ 'nullable'],
             'member_caste_id'      => [ 'nullable'],
             'ethnicity'            => [ 'nullable', 'max:255'],
             'personal_value'       => [ 'nullable', 'max:255'],
             'community_value'      => [ 'nullable', 'max:255'],
         ];
         $this->messages = [
         ...
         $spiritual_backgrounds->religion_id        = $request->member_religion_id ?? 1;
         ...
         $spiritual_backgrounds->family_status_id   = $request->family_status_id ?: null;
         $spiritual_backgrounds->community_value    = null;
